...
class ServeModelInfoResult(BaseModel):  # pylint: disable=too-few-public-methods
    """
...
class InferenceServer(BaseServer):  # pylint: disable=too-many-arguments
    ...
    def __init__(self, model, servername, host: str = '127.0.0.1', http_port: int = 8080,
                 max_buffer_size: int = 104857600, workers: int = 1):
        super(InferenceServer, self).__init__(servername=servername, host=host,
