...
class TaskModel(Base):
    ...
    id = Column(Integer, primary_key=True, index=True, autoincrement=True)
    task_id = Column(Integer, ForeignKey('ll_task_grp.id'), index=True, nullable=False)
...
class TaskRelation(Base):
    ...
    id = Column(Integer, primary_key=True, index=True, autoincrement=True)
    grp_id = Column(Integer, ForeignKey('ll_task_grp.id'), index=True, nullable=False)
    grp = relationship('TaskGrp')
    task_id = Column(Integer, ForeignKey('ll_tasks.id'), index=True, nullable=False)
...
class Samples(Base):
    ...
    data_type = Column(SmallInteger, default=0, index=True,
...
class TaskSample(Base):
    ...
    id = Column(Integer, primary_key=True, index=True, autoincrement=True)
    sample_id = Column(Integer, ForeignKey('ll_samples.id'), index=True, nullable=False)
