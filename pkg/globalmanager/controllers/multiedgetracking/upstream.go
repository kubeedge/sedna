...
func (uc *Controller) updateMultiEdgeTrackingMetrics(name, namespace string, metrics []sednav1.Metric) error {
...
func (uc *Controller) updateMultiEdgeTrackingFromEdge(name, namespace, operation string, content []byte) error {
...
func (c *Controller) SetUpstreamHandler(addFunc runtime.UpstreamHandlerAddFunc) error {
	return addFunc(KindName, c.updateMultiEdgeTrackingFromEdge)
}
