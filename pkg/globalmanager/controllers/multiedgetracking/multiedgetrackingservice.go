...
// func (mc *Controller) createWorker(service *sednav1.MultiEdgeTrackingService) error {
...
// func (mc *Controller) createEdgeWorker(service *sednav1.MultiEdgeTrackingService, reIDPort int32) error {
