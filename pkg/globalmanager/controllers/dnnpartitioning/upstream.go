...
func (uc *Controller) updateDNNPartitioningMetrics(name, namespace string, metrics []sednav1.Metric) error {
...
func (uc *Controller) updateDNNPartitioningFromEdge(name, namespace, operation string, content []byte) error {
...
func (c *Controller) SetUpstreamHandler(addFunc runtime.UpstreamHandlerAddFunc) error {
	return addFunc(KindName, c.updateDNNPartitioningFromEdge)
}
