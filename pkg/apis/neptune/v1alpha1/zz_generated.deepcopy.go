...
func (in *EdgeWorker) DeepCopyInto(out *EdgeWorker) {
	*out = *in
	out.Model = in.Model
	in.HardExampleAlgorithm.DeepCopyInto(&out.HardExampleAlgorithm)
	in.WorkerSpec.DeepCopyInto(&out.WorkerSpec)
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HardExampleAlgorithm) DeepCopyInto(out *HardExampleAlgorithm) {
	*out = *in
	if in.Parameters != nil {
		in, out := &in.Parameters, &out.Parameters
		*out = make([]ParaSpec, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HardExampleAlgorithm.
func (in *HardExampleAlgorithm) DeepCopy() *HardExampleAlgorithm {
	if in == nil {
		return nil
	}
	out := new(HardExampleAlgorithm)
	in.DeepCopyInto(out)
	return out
}
