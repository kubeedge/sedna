	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.NeptuneV1alpha1().JointInferenceServices(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NeptuneV1alpha1().JointInferenceServices(namespace).Watch(context.TODO(), options)
			},
		},
		&neptunev1alpha1.JointInferenceService{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *jointInferenceServiceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&neptunev1alpha1.JointInferenceService{}, f.defaultInformer)
}
