...
var datasetsResource = schema.GroupVersionResource{Group: "neptune.io", Version: "v1alpha1", Resource: "datasets"}

var datasetsKind = schema.GroupVersionKind{Group: "neptune.io", Version: "v1alpha1", Kind: "Dataset"}
