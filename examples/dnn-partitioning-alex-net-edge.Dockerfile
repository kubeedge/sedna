...
ENTRYPOINT ["python"]
COPY examples/dnn_partitioning/alex_net/edge_model/AlexNet.py /home/work/AlexNet.py
COPY examples/dnn_partitioning/alex_net/edge_model/edge_model.py  /home/work/edge_model.py
COPY examples/dnn_partitioning/alex_net/edge_model/interface.py  /home/work/interface.py
